...
img1 = cv.imread('C:\Espace_Python\mon espace\TAI\depth\leftt.jpg', cv.IMREAD_GRAYSCALE)
img2 = cv.imread('C:\Espace_Python\mon espace\TAI\depth\im_rightt.jpg', cv.IMREAD_GRAYSCALE)
