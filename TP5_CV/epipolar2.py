...
if len(good) < 4:
	print("La construction de lamatrice homographie est impossible car on a moin de 4 points !")
...
if len(inlier_match0) < 8:
	print("La construction de lamatrice homographie est fondamentale car on a moin de 8 points !")
	img_err = cv2.imread("C:\Espace_Python\mon espace\TAI\TP5_CV\error.png")
	cv2.imshow("Error", img_err)
	cv2.waitKey(0)
	cv2.destroyAllWindows()
